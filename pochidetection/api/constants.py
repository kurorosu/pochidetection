...
Attributes:
    ...
    MAX_BODY_SIZE: HTTP リクエスト body の最大許容バイト数.
        デフォルトは 32MB. 環境変数 ``POCHI_MAX_BODY_SIZE`` で上書き可能.
"""
...
# 環境変数 ``POCHI_MAX_BODY_SIZE`` (bytes) で上書き可能. 未設定時は 32MB.
MAX_BODY_SIZE: int = int(os.environ.get("POCHI_MAX_BODY_SIZE", str(32 * 1024 * 1024)))
