...
- 2026-04-18 ([PR #452](https://github.com/kurorosu/pochidetection/pull/452)): CUDA Event 計測結果を反映し, 真因を NVIDIA GPU driver の adaptive clock policy (低クロック維持) と確定. `nvidia-smi --lock-gpu-clocks` による検証と解決策案を追記.
